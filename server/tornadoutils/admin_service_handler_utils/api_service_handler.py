...
async def uds_call(command: str, target: Optional[str] = None) -> dict:
    """Send a JSON command to the uvicorn-manager Unix socket and return the response."""
    try:
